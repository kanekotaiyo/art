                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}"　enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="car" type="text" class="form-control" name="car" required autocomplete="car">*1
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="comment" type="text" class="form-control" name="comment" required autocomplete="comment">*1
                            </div>
                        </div>
                        <div>
